...
# Assume we already have a graph combination input


#bucket?
f = gm.Graph_Combination([0.75, -3, 3],[graph.empty_graph, graph.one_edge_graph, graph.two_edge_graph])


#defining the z vectors?
# Assume we now have a vector input
z_0 = [gm.Graph_Combination([1],[graph.one_labeled_empty_graph]),
        gm.Graph_Combination([1],[graph.one_labeled_one_edge_graph])]
...
#####CHANGE HERE#########
constraints = [Q >> 0, comb_product.coefficients[1] == 0, comb_product.coefficients[2] == 0]
